...
# Latest Nano S SDK
RUN cd /opt && git clone --branch 2.1.0-rc3 https://github.com/LedgerHQ/nanos-secure-sdk.git nanos-secure-sdk
ENV NANOS_SDK=/opt/nanos-secure-sdk

# Latest Nano X SDK
RUN cd /opt && git clone https://github.com/LedgerHQ/nanox-secure-sdk.git nanox-secure-sdk
